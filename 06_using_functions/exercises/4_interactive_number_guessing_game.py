    ...
    while play_game:
            ...
            while True:
                try:
                    max_guesses_input = input(
                        "Enter maximum guesses (leave blank for unlimited): "
                    )
        ...
        while guesses_taken < max_guesses:
                        ...
                        if hint_type == 1:
                            ...
                            if range_size > 20:
                                if secret_number <= (max_number + min_number) // 2:
                                    ...
                                    print(
                                        f"HINT: The number is between {min_number} and {max_number}."
                                    )
                                else:
                                ...
                                print(
                                    f"HINT: The number is {'prime' if is_prime else 'not prime'}."
                                )
                        elif hint_type == 3:
                            ...
                            if factors:
                                print(
                                    f"HINT: The number is divisible by {random.choice(factors)}."
                                )
                            else:
                                print(
                                    f"HINT: The number is not divisible by any number between 2 and 10."
                                )
            ...
            if guess == secret_number:
                ...
                final_score = int(
                    guess_factor * difficulty_multiplier * hint_penalty * time_factor
                )
            ...
            guesses_left = (
                "unlimited"
                if max_guesses == float("inf")
                else str(max_guesses - guesses_taken)
            )
